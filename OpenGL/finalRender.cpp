...
int main()
{
  ...
  glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shadowMap.updateLight(lights[0], glm::vec3(2.0f, 4.0f, -10.0f), 1.0f, 60.0f, 40.0f);

        const glm::mat4 lightSpaceMat = shadowMap.lightSpaceMatrix();
        const glm::mat4 bunnyModel    = glm::mat4(1.0f);
        const glm::mat4 globeModel    = glm::translate(glm::mat4(1.0f), glm::vec3(5, 8, -20));
        ...
        moonTex.bind(0);
        drawBP(ground, glm::vec3(1.0f), phongExp, groundModel, M_view);
        glUniform3fv(bp_ks, 1, glm::value_ptr(glm::vec3(0.0f)));
        drawBP(ground, glm::vec3(1.0f), phongExp, groundModel, M_view);
        glUniform3fv(bp_ks, 1, glm::value_ptr(ks));
